    ...
    <header className="fixed top-0 left-0 right-0 z-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="#contact" className="hidden sm:inline-flex rounded-full bg-gradient-to-r from-fuchsia-500 via-purple-500 to-sky-500 px-5 py-2 text-sm font-medium shadow-[0_0_40px_-10px] shadow-fuchsia-500/50 hover:opacity-95 transition-opacity">Let’s Build with AI</a>
        </div>
      </div>
    </header>
  );
